...
<div class="table-responsive">
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            <?php if($exam_qry->num_rows > 0): ?>
                <?php while($row = $exam_qry->fetch_assoc()): ?>
                    <?php 
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-sm btn-outline-primary" onclick="view_grade_details(<?php echo $row['quiz_id'] ?>, 'exam')">
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8" class="text-center">No exam records found.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
