	...
	<div class="card card-outline card-success">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="d-flex justify-content-center align-items-center">
	            ...
	            <button class="btn btn-sm btn-success bg-gradient-success" type="button" id="add_mark">Add</button>
            </div>
        </div>
    	<hr>
            ...
            <table class="table table-bordered" id="mark-list">
            	...
            	<tbody>
            		...
            		<tr data-id="<?php echo $row['sid'] ?>">
            			...
            			<td class="text-center"><input type="hidden" name="mark[]" value="<?php echo $row['mark'] ?>"><?php echo $row['mark'] ?></td>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-success mx-2" form="manage-result">Save</button>
