	...
	<div class="card card-outline card-success">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group text-dark">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-sm" name="course" value="<?php echo isset($course) ? $course : '' ?>" required>
              </div>
            </div>
            <div class="form-group text-dark">
              <div class="form-group">
  	...
  	<div class="card-footer border-top border-success">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-success mx-2" form="manage-student">Save</button>
